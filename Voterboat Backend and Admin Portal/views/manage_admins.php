...
<body>
    ...
    <div id="container">
        <center>
            <span style="display: block; margin-top: 20px; font-size: 18pt; margin-bottom: 30px;">Manage Admins</span>
            <table style="width: 580px;" cellpadding="1" cellspacing="0" bgcolor="#F5F5F5" border="1" bordercolor="#E5E5E5">
                ...
                <?php
                    $getAdmins = mysql_query("SELECT * FROM users WHERE permissions='Admin'");
