<?php
    ...
    class Users
    {
        ...
        public function create_account()
        {
            ...
            // add student
            $addStudent = mysql_query("INSERT INTO users (student_id, user_name, password) VALUES ('".$student_id."', '".$user_name."', '".sha1($password)."')");
        ...
        public function sign_in()
        {
            ...
            // check credentials
            $signIn = mysql_query("SELECT user_id FROM users WHERE user_name='".$user_name."' AND password='".sha1($password)."' LIMIT 1");
