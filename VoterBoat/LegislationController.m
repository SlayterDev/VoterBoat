...
- (void)loadElections
{
    ...
    NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:@"elections", @"controller", @"get_elections", @"method", @"Legislative", @"type", [defaults objectForKey:@"user_id"], @"user_id", nil];
