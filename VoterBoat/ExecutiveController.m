...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    {
        // Handle Time
        long remainingTime = (([[[elections objectAtIndex:indexPath.row] objectForKey:@"delete_time"] longLongValue]) - (long)[[NSDate date] timeIntervalSince1970]);        int secondsInAMinute = 60;
