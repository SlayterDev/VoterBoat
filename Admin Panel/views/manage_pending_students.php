<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        if ($email != NULL)
        {
            $message = "An admin has denied your request to join VoterBoat.";
    ...
    if (isset($_POST['approve']))
    {
        ...
        if ($email != NULL)
        {
            $message = "An admin has approved your request to join VoterBoat. You can now login through our mobile app.";
            $headers = 'From: noreply@voterboat.me' . "\r\n" .
            'Reply-To: noreply@voterboat.me' . "\r\n" .
            'X-Mailer: PHP/' . phpversion();
            mail($email, 'VoterBoat Alert', $message, $headers);
