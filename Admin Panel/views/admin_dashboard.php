<?php
    ...
    $checkIfAdmin = mysql_query("SELECT * FROM users WHERE user_id='".$_SESSION['user_id']."'");
    $adminResults = mysql_fetch_array($checkIfAdmin);
...
<body>
    ...
    <div id="form">
        <center>
            ...
            <?php
                if ($isAdmin)
                    echo '<a href="add_monitor.php"><input type="button" value="Add Monitor" class="form_btn" style="display: block; margin-bottom: 10px; width: 200px;" /></a>';
            ?>
            <?php
                if ($isAdmin)
                    echo '<a href="create_election.php"><input type="button" value="Create Election" class="form_btn" style="display: block; margin-bottom: 10px; width: 200px;" /></a>';
            ?>
            <?php
                if ($isMaster)
            ...
            <?php
                if ($isAdmin)
                    echo '<a href="manage_monitors.php"><input type="button" value="Manage Monitors" class="form_btn" style="display: block; margin-bottom: 10px; width: 200px; background-color: #3498db;"/></a>';
            ?>
            <?php
                if ($isAdmin)
                    echo '<a href="manage_students.php"><input type="button" value="Manage Students" class="form_btn" style="display: block; margin-bottom: 10px; width: 200px; background-color: #3498db;" /></a>';
            ?>
            ...
            <?php
                if ($isAdmin)
                    echo '<a href="manage_voters.php"><input type="button" value="Manage Voters" class="form_btn" style="display: block; margin-bottom: 10px; width: 200px; background-color: #3498db;" /></a>';
            ?>
